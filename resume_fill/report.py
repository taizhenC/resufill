...
def build(
    *,
    ...
    lines: list[str] = [
        ...
        headline,
        "",
        "> This number is a **local proxy**, and nothing reproduces it. Several ATS platforms do",
        "> score a résumé now — Greenhouse Talent Matching, Lever Talent Fit, Workday, Ashby — but",
        "> each scores against an employer's own calibration that you cannot see, and each is",
        "> documented as advisory input to a human. Treat this as a stopping rule for the rewrite",
        "> loop, not as a prediction of any of them.",
        "",
        *_table(score),
        "",
